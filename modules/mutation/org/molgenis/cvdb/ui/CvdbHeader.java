...
public class CvdbHeader extends PluginModel<Entity>
{
	...
	public CvdbHeader(String name, ScreenController<?> parent)
	{
		super(name, parent);
	}
	...
	{
		return "org_molgenis_mutation_ui_header_CvdbHeader";
	}

	@Override
	public String getViewTemplate()
	{
		return "org/molgenis/mutation/ui/header/CvdbHeader.ftl";
	}
