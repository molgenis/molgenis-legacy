...
<p>
For obtaining consent, you can download the provided <a href="res/mutation/consent_form.pdf">consent form</a>. We do currently not require you to upload consent forms to our system. By indicating that the patient consented, you confirm that a signed consent form is in your possession.
</p>
<hr/>
<br/>
...
<tr>
	...
	<td><a href="res/mutation/col7a1_template.xls">Example template</a></td>
