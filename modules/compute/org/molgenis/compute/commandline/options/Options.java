...
/**
 * Constructor. The prefix is set to {@link org.molgenis.compute.commandline.options.Options.Prefix#DASH}.
 * <p>
 * @param args                The command line arguments to check
 * @param defaultMultiplicity The default multiplicity to use for all options (can be overridden when adding an option)
 * @param defMinData          The default minimum number of data items for all sets (can be overridden when adding a set)
...
/**
 * Constructor. The prefix is set to {@link org.molgenis.compute.commandline.options.Options.Prefix#DASH}, and the default number of data items is set to 0.
 * <p>
 * @param args                The command line arguments to check
 * @param defaultMultiplicity The default multiplicity to use for all options (can be overridden when adding an option)
 * <p>
...
/**
 * Constructor. The prefix is set to {@link org.molgenis.compute.commandline.options.Options.Prefix#DASH}, the default number of data items is set to 0, and
 * the multiplicity is set to {@link org.molgenis.compute.commandline.options.Options.Multiplicity#ONCE}.
 * <p>
 * @param args The command line arguments to check
 * <p>
...
/**
 * Constructor. The prefix is set to {@link org.molgenis.compute.commandline.options.Options.Prefix#DASH}, and
 * the multiplicity is set to {@link org.molgenis.compute.commandline.options.Options.Multiplicity#ONCE}.
 * <p>
 * @param args The command line arguments to check
 * @param data The default minimum and maximum number of data items for all sets (can be overridden when adding a set)
...
/**
 * Constructor. The multiplicity is set to {@link org.molgenis.compute.commandline.options.Options.Multiplicity#ONCE}.
 * <p>
 * @param args   The command line arguments to check
 * @param prefix The prefix to use for all command line options. It can only be set here for all options at 
 * @param data   The default minimum and maximum number of data items for all sets (can be overridden when adding a set)
...
/**
 * Add the given non-value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, org.molgenis.compute.commandline.options.Options.Multiplicity)} for details.
 */
 ...
 * See {@link OptionSet#addOption(String, org.molgenis.compute.commandline.options.Options.Separator)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, org.molgenis.compute.commandline.options.Options.Separator, org.molgenis.compute.commandline.options.Options.Multiplicity)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, boolean, org.molgenis.compute.commandline.options.Options.Separator)} for details.
 */
...
/**
 * Add the given value option to <i>all</i> known sets.
 * See {@link OptionSet#addOption(String, boolean, org.molgenis.compute.commandline.options.Options.Separator, org.molgenis.compute.commandline.options.Options.Multiplicity)} for details.
 */
