...
The following figures show the insert size distribution per sample \textit{per flowcell/lane}. Insert refers to the base pairs that are ligated between the adapters.
${figuresInsertSize(insertsizemetricspdf)}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\begin{center}
		\includegraphics[width=.5\textwidth]{${workflowpng}}
	\end{center}
