...
public class JQGridPlugin extends EasyPluginController<ScreenModel> {
    ...
    /**
     * The options for export ranges: <ul> <li>GRID : Only the data currently
     * displayed by the grid</li> <li>ALL : All data</li> <li>UNKNOWN :
     * unknown.</li> </ul>
     */
...
//    }
    ...
    private void renderData(HttpServletRequest request, HttpServletResponse response, int page, int totalPages,
        ...
        try {
            ...
            view.export(servletContext, request, response, request.getParameter("caption"), this, tupleTable, totalPages, page);
        } catch (Exception e) {
...
//    }
     ...
     * @param rules The already-applied rules, to which the new sorting rule
     * will be added.
     */
