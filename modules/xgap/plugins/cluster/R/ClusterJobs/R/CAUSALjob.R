...
######################################################################
#
# run_CAUSAL: Bach detection on phenotype data using correlations
#
######################################################################

run_CAUSAL <- function(dbpath = "", subjob, item, jobid, outname, myanalysisfile, jobparams=list(c("message","hello World")), investigationname="", libraryloc=NULL){
