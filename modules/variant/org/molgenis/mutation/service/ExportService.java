...
public class ExportService
{
	...
	{
		List<Patient> patients = this.db.query(Patient.class).equals(Patient.CONSENT, "publication").find();
...
//		
//		List<SequenceCharacteristic> mutations = patient.getMutations();
//
//		if (mutations.size() > 0)
//		{
//			SequenceCharacteristic mutation1 = mutations.get(0);
