...
//import org.molgenis.matrix.test.VerifyCsv;
...
// */
//public class BinaryMatrixWriter implements MatrixWriter
//{
...
//	/**
//	 * Wrapper constructor
//	 * Writes a binary matrix to the filesystem
//	 * @param data
//	 * @param inputFile
//	 * @param db
//	 * @param testMode
//	 * @throws Exception
//	 */
//	public BinaryMatrixWriter(String header, File outputFile) throws Exception
//	{
//		HashMap<Data, File> dataFileMap = new HashMap<Data, File>();
//		dataFileMap.put(data, inputFile);
//		new BinaryMatrixWriter(dataFileMap);
//	}
//
//	/**
//	 * Wrapper constructor
...
//	 * @throws Exception
//	 */
//	public BinaryMatrixWriter(List<Data> dataList, File inputDir, Database db)
//			throws Exception
//	{
...
//		}
//		
//		new BinaryMatrixWriter(dataFileMap, db);
//	}
//
//	/**
...
//	 * @throws Exception
//	 */
//	public BinaryMatrixWriter(HashMap<Data, File> dataFileMap, Database db)
//			throws Exception
//	{
//
...
//		if (src == null || !src.exists()){
//			throw new VerifyCsvException("Source file '"+fileString+"' not found at location '"+src.getAbsolutePath()+"'");
//		}
//		if(!src.getName().endsWith(".txt")){
//			throw new VerifyCsvException("Source file name '"+fileString+"' does not end with '.txt', are you sure it is a CSV matrix?");
//		}
//		
...
//											+ elementLength.get());
//									logger
//											.info("Element of unequal size found, exiting from function by throwing error");
//									elementLength.set(0);
