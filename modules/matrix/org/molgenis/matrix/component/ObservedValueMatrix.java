		...
		implements SliceableMatrix<R, C, List<ObservedValue>>
{
	...
	@Override
	public SliceableMatrix<R, C, List<ObservedValue>> slice(MatrixQueryRule rule)
	...
	@Override
	public SliceableMatrix<R, C, List<ObservedValue>> sliceByColValueProperty(
			C col, String property, Operator operator, Object value)
			throws MatrixException {
		// TODO Auto-generated method stub
		return null;
	}
