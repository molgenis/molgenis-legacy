...
public interface SliceableMatrix {
	 ...
	 * Retrieving nRows 1, nCols 1 from index 0,0 returns the first (upper left most) element of the matrix.
	 * @param matrix
	 * @param rowIndex
	 * @param nRows
	 * @param colIndex
	 ...
	 * @throws Exception
	 */
	public RenderableMatrix getSubMatrixByOffset(RenderableMatrix matrix, int rowIndex, int nRows, int colIndex, int nCols) throws Exception;
