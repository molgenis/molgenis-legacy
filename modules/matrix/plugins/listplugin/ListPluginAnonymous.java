...
public class ListPluginAnonymous extends PluginModel<Entity> {
	...
	public ListPluginAnonymous(String name, ScreenController<?> parent) {
		super(name, parent);
	}
	...
	public String getViewName() {
		return "plugins_listplugin_ListPluginAnonymous";
	}

	@Override
	public String getViewTemplate() {
		return "plugins/listplugin/ListPluginAnonymous.ftl";
	}
