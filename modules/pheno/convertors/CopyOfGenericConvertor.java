...
public class CopyOfGenericConvertor
{
	...
	public CopyOfGenericConvertor() throws Exception
	{
	...
	public void populateIndividual(File file, String invName) throws Exception
	{
		...
		for (Tuple tuple : reader)
		{
			...
			String id = tuple.getString("PA_ID");
	...
	public void populateValue(File file, String invName) throws Exception
	{
		...
		for (Tuple tuple : reader)
		{
			...
			String targetName = tuple.getString("PA_ID");
