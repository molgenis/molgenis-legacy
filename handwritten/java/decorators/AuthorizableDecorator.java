...
public class AuthorizableDecorator<E extends org.molgenis.auth.Authorizable> extends JpaMappingDecorator<E>
{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		// for (org.molgenis.auth.Authorizable e : entities)
		// {
