...
public class MolgenisFileDecorator<E extends org.molgenis.core.MolgenisFile> extends JpaMappingDecorator<E>
{
	//Mapper is the generate thing
	public MolgenisFileDecorator(Mapper generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		// for (org.molgenis.core.MolgenisFile e : entities)
		// {
