...
public class GeneralHelpPlugin extends PluginModel<Entity> {

	private static final long serialVersionUID = 6154765418901893635L;

	public GeneralHelpPlugin(String name, ScreenModel<Entity> parent) {
		super(name, parent);
	}
