...
/**
 * QTLDataSetWizardController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>QTLDataSetWizardModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>QTLDataSetWizardView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class QTLDataSetWizard extends EasyPluginController<QTLDataSetWizardModel>
{
	public QTLDataSetWizard(String name, ScreenController<?> parent)
	{
		...
		this.setModel(new QTLDataSetWizardModel(this)); //the default model
		this.setView(new FreemarkerView("QTLDataSetWizardView.ftl", getModel())); //<plugin flavor="freemarker"
	}
