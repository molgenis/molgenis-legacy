 ...
 */
public abstract class Matrix2<E>
{
	...
	public Matrix2<E> getSubMatrix(List<String> rowNames, List<String> colNames) throws Exception{
	 ...
	 *             if row or column names are not known
	 */
	public abstract Matrix2<E> getSubMatrix(int[] rowIndices, int[] colIndices) throws Exception;
	 ...
	 * 
	 */
	public abstract Matrix2<E> getSubMatrix(int row, int nRows, int col, int nCols) throws Exception;
	 ...
	 * @throws Exception 
	 */
	public Matrix2<E> getSubMatrix(String rowName, int nRows, String colName, int nCols) throws Exception{
