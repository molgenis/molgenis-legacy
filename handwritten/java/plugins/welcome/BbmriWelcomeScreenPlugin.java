...
/**
 * BbmriWelcomeScreenPluginController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>BbmriWelcomeScreenPluginModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>BbmriWelcomeScreenPluginView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class BbmriWelcomeScreenPlugin extends EasyPluginController<BbmriWelcomeScreenPluginModel>
{
	public BbmriWelcomeScreenPlugin(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new BbmriWelcomeScreenPluginModel(this)); //the default model
		this.setView(new FreemarkerView("BbmriWelcomeScreenPluginView.ftl", getModel())); //<plugin flavor="freemarker"
	}
