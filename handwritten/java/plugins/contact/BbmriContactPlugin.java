...
/**
 * BbmriContactPluginController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>BbmriContactPluginModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>BbmriContactPluginView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class BbmriContactPlugin extends EasyPluginController<BbmriContactPluginModel>
{
	public BbmriContactPlugin(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new BbmriContactPluginModel(this)); //the default model
		this.setView(new FreemarkerView("BbmriContactPluginView.ftl", getModel())); //<plugin flavor="freemarker"
	}
