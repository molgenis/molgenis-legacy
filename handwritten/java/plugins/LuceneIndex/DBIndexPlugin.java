...
/**
 * DBIndexPluginController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>DBIndexPluginModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>DBIndexPluginView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class DBIndexPlugin extends EasyPluginController<DBIndexPluginModel>
{
	public DBIndexPlugin(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new DBIndexPluginModel(this)); //the default model
		this.setView(new FreemarkerView("DBIndexPluginView.ftl", getModel())); //<plugin flavor="freemarker"
	}
