...
######################################################################
#
# run_DIFCOR: Differential correlations (Arends and Bruno et al)
#
######################################################################

run_DIFCOR <- function(dbpath = "", subjob, item, jobid, outname, myanalysisfile, jobparams=list(c("message","hello World")), investigationname="", libraryloc=NULL){
