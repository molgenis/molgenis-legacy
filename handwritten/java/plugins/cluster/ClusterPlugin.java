...
/**
 * ClusterPluginController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>ClusterPluginModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>ClusterPluginView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class ClusterPlugin extends EasyPluginController<ClusterPluginModel>
{
	public ClusterPlugin(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new ClusterPluginModel(this)); //the default model
		this.setView(new FreemarkerView("ClusterPluginView.ftl", getModel())); //<plugin flavor="freemarker"
	}
