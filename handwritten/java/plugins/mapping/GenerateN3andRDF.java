...
/**
 * GenerateN3andRDFController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>GenerateN3andRDFModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>GenerateN3andRDFView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class GenerateN3andRDF extends EasyPluginController<GenerateN3andRDFModel>
{
	public GenerateN3andRDF(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new GenerateN3andRDFModel(this)); //the default model
		this.setView(new FreemarkerView("GenerateN3andRDFView.ftl", getModel())); //<plugin flavor="freemarker"
	}
