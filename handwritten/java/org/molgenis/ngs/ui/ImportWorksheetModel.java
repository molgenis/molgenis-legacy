 ...
 */
public class ImportWorksheetModel extends EasyPluginModel
{
	//a system veriable that is needed by tomcat
	private static final long serialVersionUID = 1L;
	//this string can be referenced from ImportWorksheetView.ftl template as ${model.helloWorld}
	...
	public ImportWorksheetModel(ImportWorksheet controller)
	{
