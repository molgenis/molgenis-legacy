...
public class PermissionManagementService {
	...
	/** Given a role id and an entity id, searches for a MolgenisPermission on a particular
	 ...
	 * @param permType the type of permission (i.e. READ, WRITE, EXECUTE, or OWN)
	 ...
	 * of MolgenisPermissions matching these parameters.
	 * 
	 * @param id
	 * @param permType
	 * @return
	...
	/** Given a role id, return a list of MolgenisPermissions for all users, where the given roleId
	 * owns the entity in the matched MolgenisPermissions.
	 * 
	 * @param roleId role id
	 * @param includeOwnership whether to include the permission for ownership from the given role
	 * @return List<MolgenisPermission> all matching Permissions
	 * @throws ParseException 
	 * @throws DatabaseException 
	 */
	public List<MolgenisPermission> findUserPermissions(Integer roleId, boolean includeOwnership) throws DatabaseException, ParseException {
	 ...
	 * @throws DatabaseException 
	 */
	public List<MolgenisPermission> findUserPermissions(Integer roleId, Integer entityId) throws DatabaseException, ParseException {
	 ...
	 * 
	 * @param userId userId of user trying to update
	 * @param mp MolgenisPermission to update
	 * @throws ParseException 
	 * @throws DatabaseException 
	 * @throws IOException 
	 * 
	 ...
	 * 
	 * @param userId userId of user trying to insert
	 * @param mp MolgenisPermission to insert
	 * @throws ParseException 
	 * @throws DatabaseException 
	 * @throws IOException 
	 * 
	...
	/** Remove a permission based on permission id. RoleId is also required to check for sufficient 
	 * rights.
	 * 
	 * @param roleId MolgenisRole id
	 * @param permId MolgenisPermission id
	 * @throws DatabaseException
	 * @throws IOException
	 * @throws ParseException
	 */
