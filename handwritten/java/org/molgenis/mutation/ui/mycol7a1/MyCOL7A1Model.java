 ...
 */
public class MyCOL7A1Model extends EasyPluginModel
{
	//a system veriable that is needed by tomcat
	private static final long serialVersionUID = 1L;
	//this string can be referenced from MyCOL7A1View.ftl template as ${model.helloWorld}
	public String helloWorld = "hello World";
	//this date can be referenced from MyCOL7A1View.ftl template as ${model.date}
	...
	public MyCOL7A1Model(MyCOL7A1 controller)
	{
