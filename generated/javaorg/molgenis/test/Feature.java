...
//@EntityListeners({org.molgenis.test.db.FeatureEntityListener.class})
public class Feature extends org.molgenis.test.Characteristic 
{
	// fieldname constants
...
//1
    ...
    private java.util.Collection<org.molgenis.test.Category> featureCategoryCollection = new java.util.ArrayList<org.molgenis.test.Category>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.test.Category> getFeatureCategoryCollection()
	{
            return featureCategoryCollection;
	}

    public void setFeatureCategoryCollection(java.util.Collection<org.molgenis.test.Category> collection)
    {
        for (org.molgenis.test.Category category : collection) {
