...
/**
 * NgsHeaderController takes care of all user requests and application logic.
 *
 * <li>Each user request is handled by its own method based action=methodName. 
 * <li> MOLGENIS takes care of db.commits and catches exceptions to show to the user
 * <li>NgsHeaderModel holds application state and business logic on top of domain model. Get it via this.getModel()/setModel(..)
 * <li>NgsHeaderView holds the template to show the layout. Get/set it via this.getView()/setView(..).
 */
public class NgsHeader extends EasyPluginController<NgsHeaderModel>
{
	public NgsHeader(String name, ScreenController<?> parent)
	{
		super(name, null, parent);
		this.setModel(new NgsHeaderModel(this)); //the default model
		this.setView(new FreemarkerView("NgsHeaderView.ftl", getModel())); //<plugin flavor="freemarker"
	}
