...
public class ContactModel extends EasyPluginModel
{
	...
	//this string can be referenced from ContactView.ftl template as ${model.helloWorld}
	public String helloWorld = "hello World";
	//this date can be referenced from ContactView.ftl template as ${model.date}
