...
public class AnimalDbFileViewer extends PluginModel<Entity>
{

	private static final long serialVersionUID = 7832540415673199206L;

	public AnimalDbFileViewer(String name, ScreenController<?> parent)
	{
		super(name, parent);
	}

	private AnimalDbFileViewerModel model = new AnimalDbFileViewerModel();

	public AnimalDbFileViewerModel getMyModel()
	{
		return model;
	}
	...
	{
		return "AnimalDbFileViewer";
	}

	@Override
	public String getViewTemplate()
	{
		return "org/molgenis/animaldb/plugins/viewers/AnimalDbFileViewer.ftl";
	}
