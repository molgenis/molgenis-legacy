...
public class MeasurementDecorator<E extends org.molgenis.protocol.ComputeFeature> extends MappingDecorator<E>
{
	//JDBCMapper is the generate thing
//	public MeasurementDecorator(JDBCMapper generatedMapper)
//	{
//		super(generatedMapper);
//	}

	//Mapper is the generate thing
	public MeasurementDecorator(Mapper generatedMapper)
	{
		super(generatedMapper);
	}
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		// for (org.molgenis.protocol.ComputeFeature e : entities)
		// {
