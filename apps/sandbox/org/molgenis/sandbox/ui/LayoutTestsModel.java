...
/**
 * LayoutTestsModel takes care of all state and it can have helper methods to query the database.
...
public class LayoutTestsModel extends EasyPluginModel
{
	...
	//this string can be referenced from LayoutTestsView.ftl template as ${model.helloWorld}
	public String helloWorld = "hello World";
	//this date can be referenced from LayoutTestsView.ftl template as ${model.date}
