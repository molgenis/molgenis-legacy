...
public class InvestigationVaadin extends PluginModel
{
	public InvestigationVaadin(String name, ScreenController<?> parent)
	{
		super(name, parent);
	}
	...
	{
		return "org_molgenis_sandbox_plugins_InvestigationVaadin";
	}

	@Override
	public String getViewTemplate()
	{
		return "org/molgenis/sandbox/ui/InvestigationVaadin.ftl";
	}
...
//		}
	...
	{
		String divId = "vaadin_investigations";
		//path with the vaadin app serlvet (including trailing slash)
		String servletPath = "/molgenis_apps/vaadin-apps/investigations/";
