...
public class EAVToView {
    ...
    public EAVToView(String schemaName, String tableName, String fields, String schemaToExportView, int protocolId, String databaseTarget, int investigationId) throws DatabaseException, Exception {
