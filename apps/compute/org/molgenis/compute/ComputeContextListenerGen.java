...
public class ComputeContextListenerGen extends Generator
{
	public static final transient Logger logger = Logger.getLogger(ComputeContextListenerGen.class);
			...
			throws Exception
	{
		...
		File target = new File( this.getSourcePath(options)+ APP_DIR+"/servlet/ContextListener.java" );
