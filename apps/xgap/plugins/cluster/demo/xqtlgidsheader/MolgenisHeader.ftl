...
-->
<#macro plugins_cluster_demo_xqtlgidsheader_MolgenisHeader screen>

<div style="height:10px;">&nbsp;</div>

<div id="sample_div" style="background-image:url(clusterdemo/bg/green_ab2.png); width: 900px; height: 125px; line-height:7.5em;">
