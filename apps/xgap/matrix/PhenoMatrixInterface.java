 ...
 */
public abstract class PhenoMatrixInterface<E>
{
	...
	public PhenoMatrixInterface<E> getSubMatrix(List<String> rowNames, List<String> colNames) throws Exception{
	 ...
	 *             if row or column names are not known
	 */
	public abstract PhenoMatrixInterface<E> getSubMatrix(int[] rowIndices, int[] colIndices) throws Exception;
	 ...
	 * 
	 */
	public abstract PhenoMatrixInterface<E> getSubMatrix(int row, int nRows, int col, int nCols) throws Exception;
	 ...
	 * @throws Exception 
	 */
	public PhenoMatrixInterface<E> getSubMatrix(String rowName, int nRows, String colName, int nCols) throws Exception{
