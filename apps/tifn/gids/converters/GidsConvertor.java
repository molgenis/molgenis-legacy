...
public class GidsConvertor
{
	...
	public List<Conflicts> converter(File file, String invName, Database db, String individual, String father, String mother,String sample, List<String> samplemeaslist, List<String> indvmeaslist, HashMap<String,String> hashChangeMeas, PMconverterandloaderPlugin pmp,String checkNewData) throws Exception{
	...
	public void populateIndividualAndSample(File file, String invName,final String individual, final String father, final String mother, final String sample, final PMconverterandloaderPlugin pmp) throws Exception
	{
...
//		String unknown = "301-";
//		List<GidsSample> b = db.query(GidsSample.class).like(GidsSample.NAME, unknown).find();
...
//	}
	...
	public void populateValue(File file, String invName,final String individual, final String sample, final List<String> samplemeaslist, final HashMap<String,String> hashChangeMeas, final String investigation,final String checkNewData) throws Exception
	{
		valuesList.clear();
		alIndividuals.clear();
	...
	public void checkForupdates(String target,String featureName,String value, String sample) throws DatabaseException{	
					...
					if(value!=null){
						if(!knownConflicts.contains(target+featureName)){
							if(!featureName.equals(sample)){
								con.setVariables(target,featureName,idValue, pm.getHashIndFeaVal().get(target+"-"+featureName),value);
								listUpdate.add(con);
