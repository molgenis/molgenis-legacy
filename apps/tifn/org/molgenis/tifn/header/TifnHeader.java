...
package org.molgenis.tifn.header;
 ...
 */
public class TifnHeader extends PluginModel<Entity>
{
	private static final long serialVersionUID = 6155556950170399575L;

	public TifnHeader(String name, ScreenController<?> parent)
	{
		super(name, parent);
	}
	...
	{
		return "org_molgenis_tifn_header_TifnHeader";
	}
