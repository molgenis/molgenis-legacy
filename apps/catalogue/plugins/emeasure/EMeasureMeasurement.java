...
public class EMeasureMeasurement {
	...
	public String addXML(Measurement m, Database db) throws Exception {
		...
		out.append("<value xsi:type=\""+datatype+"\" code=\""+codeDatatype+"\" codeSystem=\""+codeSystemDatatype+"\""+
				" displayName=\""+displayNameDatatype+"\" />");
		
		
//		List<OntologyTerm> otList = db.find(OntologyTerm.class, new QueryRule(OntologyTerm.ID, Operator.IN, m.getOntologyReference_Id()));
