...
//    	this.databaseTarget = databaseTarget;
    ...
    public static String createQuery(int investigationId, Protocol protocol, List<Measurement> measurements, Database db) throws Exception {
...
//    	EntityManager em = db.getEntityManager();
//    	String query = createQuery(investigationId, protocolId, fields, db);
//        String viewQuery = "";
