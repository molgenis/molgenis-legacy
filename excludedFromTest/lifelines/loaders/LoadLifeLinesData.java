...
public class LoadLifeLinesData {
	public static void main(String[] args) throws Exception {
		...
		//File dir = new File("/Users/jorislops/Desktop/Archive/data");
		File dir = new File("/Users/jorislops/Desktop/Archive/data");
				...
				for (int i = 0; i < columns.length; ++i) {
					...
					if (fList.size() > 0) {
						features[i] = fList.get(0);
                                            ...
                                            fieldName = fieldName.substring(fieldName.indexOf("(")+1, fieldName.indexOf(")")).trim();
                                            fList = db.find(
                        		Measurement.class, new QueryRule("name",
									Operator.EQUALS, tableName
											+ "."
