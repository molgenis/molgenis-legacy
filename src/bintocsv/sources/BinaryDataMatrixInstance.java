...
/**
 * Modified, standalone version of xQTL binary matrix 1.0
 * @author joeri
 *
 */
public class BinaryDataMatrixInstance
{
	private Data data;
	...
	public BinaryDataMatrixInstance(File bin) throws Exception
	{
		...
		if (dataDescription.getValueType().equals("Text"))
		{
			...
			System.out.println("this.getTextElementLength() = "
