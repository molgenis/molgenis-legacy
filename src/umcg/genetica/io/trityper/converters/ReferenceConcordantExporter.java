 ...
 * @author harmjan
 */
public class ReferenceConcordantExporter {
    ...
    private HashSet<String> uniquebatches;
    private HashMap<String, String> sampleInBatch;
    ...
    public ReferenceConcordantExporter() {
    ...
    public void export(String referenceLoc, String datasetLoc, String batches, String excludesnps, String output) throws IOException, Exception {
...
//	    warning[s] += "AlleleFrequenciesDiffer:" + output;
	...
	for (int s = 0; s < numSNPs; s++) {
		...
		if (s2 >= 0 && s2 < numSNPs && s2 != s) {
			...
			double rSquared = ldcalcdataset.getRSquared(datasetSNP1, datasetSNP2, ldcalcdataset.RETURN_R_SQUARED, ldcalcdataset.INCLUDE_CASES_AND_CONTROLS, false);
			double rSquaredHapMap = ldcalchapmap.getRSquared(referenceSNP1, referenceSNP2, ldcalcdataset.RETURN_R_SQUARED, ldcalcdataset.INCLUDE_CASES_AND_CONTROLS, false);
...
//	System.exit(0);
	...
	for (int i = 0; i < individuals.length; i++) {
		...
		Integer filehandle = batchtofile.get(batch);
