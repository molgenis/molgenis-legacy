...
public abstract class AsyncMolgenisFrontController extends MolgenisFrontController implements
AsyncMolgenisService
{
	// helper vars
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
	{
		try
		{
			...
			AsyncMolgenisRequest req = new AsyncMolgenisRequest(request, response); //TODO: Bad, but needed for redirection. DISCUSS.
