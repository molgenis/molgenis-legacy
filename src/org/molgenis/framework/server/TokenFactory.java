...
public class TokenFactory
{
	...
	/**
	 * Create a new token and put it in the map of all tokens.
	 * Returns the token ID that was given out for convenience.
	 * @param userName
	 * @param validUntil
	 * @return
	 */
	...
	/**
	 * Remove tokens that are expired. Called automatically on 1) any 'token login' attempt
	 * to prevent use of bad tokens 2) creation of new tokens.
	 */
