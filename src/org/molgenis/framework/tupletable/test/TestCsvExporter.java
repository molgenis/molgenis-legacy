...
{
	/**
	 * Test by first using CsvExport to export table1, and the CsvTable to read
	 * it back as table2. Obviously table1.equals(table2) == true.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testCsvRoundTrip() throws Exception
	{
		...
		for (int i = 0; i < rows1.size(); i++)
		{
			...
			{
				// nb: this doesn't do type safety as roundtrip will return
				// strings
