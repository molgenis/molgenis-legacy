...
import org.molgenis.framework.tupletable.impl.JdbcTable;
...
public class TestJdbcTable
{
	...
	public void setup() throws DatabaseException
	{
		...
		// FIXME: no access to DatabaseFactory in molgenis core.. is there a
		// different way to test this? is this test even used?
	}
	...
	public void testJDBCTable() throws SQLException, DatabaseException, TableException
	{
		...
		final TupleTable countryLikeCondition = new JdbcTable(db, "SELECT Name, Continent FROM Country", Arrays.asList(
				new QueryRule("Name", Operator.LIKE, "NETH"), sortDesc));
