...
<tr class="form_listrow${rowcolor}">
	<td>
		<label>${offset}. 
		<#if readonly == "*" >
			<img class="edit_button" src="generated-res/img/recordview.png" title="view record" alt="edit${offset}" onClick="setInput('${screen.name}_form','_self','','${screen.name}','editview','iframe'); document.forms.${screen.name}_form.__offset.value='${offset?string.computer}'; document.forms.${screen.name}_form.submit();">${readonly}</label>
		<#else>
