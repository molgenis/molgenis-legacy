 ...
 * of this type is to link two object belonging together.
 * 
...
public class Pair<T, T2>
{
	...
	/**
	 * Specific constructor, which initializes the two values to the two
	 * values passed as parameters. After this call the pair is owner of
	 * the two objects.
	 * 
