...
/**
 * A method-schema describes a number of methods, which can be exposed with something
 * like webservices. This class acts as the schema-collection for single methods.
 */
